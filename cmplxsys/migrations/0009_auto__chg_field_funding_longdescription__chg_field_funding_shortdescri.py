...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Funding.longdescription'
        db.alter_column(u'cmplxsys_funding', 'longdescription', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Funding.shortdescription'
        db.alter_column(u'cmplxsys_funding', 'shortdescription', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Project.description'
        db.alter_column(u'cmplxsys_project', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Paper.abstract'
        db.alter_column(u'cmplxsys_paper', 'abstract', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Funding.longdescription'
        db.alter_column(u'cmplxsys_funding', 'longdescription', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Changing field 'Funding.shortdescription'
        db.alter_column(u'cmplxsys_funding', 'shortdescription', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Project.description'
        db.alter_column(u'cmplxsys_project', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Paper.abstract'
        db.alter_column(u'cmplxsys_paper', 'abstract', self.gf('django.db.models.fields.CharField')(max_length=2000))
