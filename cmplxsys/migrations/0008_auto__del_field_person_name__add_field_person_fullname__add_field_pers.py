...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cmplxsys_person', 'name')

        # Adding field 'Person.fullname'
        db.add_column(u'cmplxsys_person', 'fullname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Person.first'
        db.add_column(u'cmplxsys_person', 'first',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.middle'
        db.add_column(u'cmplxsys_person', 'middle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.last'
        db.add_column(u'cmplxsys_person', 'last',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.sur'
        db.add_column(u'cmplxsys_person', 'sur',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'cmplxsys_person', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'Person.fullname'
        db.delete_column(u'cmplxsys_person', 'fullname')

        # Deleting field 'Person.first'
        db.delete_column(u'cmplxsys_person', 'first')

        # Deleting field 'Person.middle'
        db.delete_column(u'cmplxsys_person', 'middle')

        # Deleting field 'Person.last'
        db.delete_column(u'cmplxsys_person', 'last')

        # Deleting field 'Person.sur'
        db.delete_column(u'cmplxsys_person', 'sur')
