...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'twython_django_annotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hedonometer.Book'])),
        ...
        db.send_create_signal(u'twython_django', ['Annotation'])


    def backwards(self, orm):
        # Deleting model 'Annotation'
        db.delete_table(u'twython_django_annotation')
