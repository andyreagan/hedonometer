...
echo "books"
cat bootstrap.css font-awesome.min.css site.css books.css datepicker.css > books-all.css
minify --type css books-all.css > books-all.min.css

echo "maps"
cat bootstrap.css font-awesome.min.css site.css maps.css > maps-all.css
