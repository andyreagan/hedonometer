...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Embeddable.nickName'
        db.add_column(u'hedonometer_embeddable', 'nickName',
                      self.gf('django.db.models.fields.CharField')(default='My super wordshift.', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Embeddable.nickName'
        db.delete_column(u'hedonometer_embeddable', 'nickName')
