...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Embeddable.author'
        db.add_column(u'hedonometer_embeddable', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Embeddable.author'
        db.delete_column(u'hedonometer_embeddable', 'author_id')
