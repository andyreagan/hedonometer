    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(default='world', max_length=100)),
            ],
            options={
                'ordering': ('date',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100)),
                ('customLongTitle', models.CharField(default='Average Happiness for Twitter', max_length=200)),
                ('mediaFlag', models.CharField(default='Tweets', max_length=50)),
                ('language', models.CharField(max_length=100)),
                ('regionID', models.CharField(blank=True, max_length=100, null=True)),
                ('startDate', models.DateTimeField()),
                ('endDate', models.DateTimeField()),
                ('sumHappsFile', models.CharField(default='sumhapps.csv', help_text='dont change this', max_length=100)),
                ('ignoreWords', models.CharField(blank=True, max_length=400, null=True)),
            ],
            options={
                'ordering': ('title',),
