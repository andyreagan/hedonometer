...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timeseries.startDate'
        db.add_column(u'hedonometer_timeseries', 'startDate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 10, 0, 0)),
                      keep_default=False)

        # Adding field 'Timeseries.endDate'
        db.add_column(u'hedonometer_timeseries', 'endDate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 10, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timeseries.startDate'
        db.delete_column(u'hedonometer_timeseries', 'startDate')

        # Deleting field 'Timeseries.endDate'
        db.delete_column(u'hedonometer_timeseries', 'endDate')
