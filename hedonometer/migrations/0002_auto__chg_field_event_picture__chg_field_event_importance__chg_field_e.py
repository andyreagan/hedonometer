...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hedonometer_event', 'picture', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.picture'
        db.alter_column(u'hedonometer_event', 'picture', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Event.importance'
        db.alter_column(u'hedonometer_event', 'importance', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Event.y'
        db.alter_column(u'hedonometer_event', 'y', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Event.x'
        db.alter_column(u'hedonometer_event', 'x', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        u'hedonometer.event': {
            ...
            'importance': ('django.db.models.fields.CharField', [], {'max_length': '4'}),
            ...
            'x': ('django.db.models.fields.CharField', [], {'max_length': '4'}),
            'y': ('django.db.models.fields.CharField', [], {'max_length': '4'})
        }
    }
