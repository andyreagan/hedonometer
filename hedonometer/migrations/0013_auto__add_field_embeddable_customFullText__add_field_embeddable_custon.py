...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Embeddable.customFullText'
        db.add_column(u'hedonometer_embeddable', 'customFullText',
                      self.gf('django.db.models.fields.CharField')(max_length=600, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Embeddable.custonTitleText'
        db.add_column(u'hedonometer_embeddable', 'custonTitleText',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Embeddable.contextFlag'
        db.add_column(u'hedonometer_embeddable', 'contextFlag',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Embeddable.customFullText'
        db.delete_column(u'hedonometer_embeddable', 'customFullText')

        # Deleting field 'Embeddable.custonTitleText'
        db.delete_column(u'hedonometer_embeddable', 'custonTitleText')

        # Deleting field 'Embeddable.contextFlag'
        db.delete_column(u'hedonometer_embeddable', 'contextFlag')
    ...
    models = {
        ...
        u'hedonometer.embeddable': {
            ...
            'custonTitleText': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
