...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Embeddable.lang'
        db.add_column(u'hedonometer_embeddable', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='english', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Embeddable.lang'
        db.delete_column(u'hedonometer_embeddable', 'lang')
