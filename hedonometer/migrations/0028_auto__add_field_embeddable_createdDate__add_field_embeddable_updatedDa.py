...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Embeddable.createdDate'
        db.add_column(u'hedonometer_embeddable', 'createdDate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Embeddable.updatedDate'
        db.add_column(u'hedonometer_embeddable', 'updatedDate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Embeddable.stopWords'
        db.add_column(u'hedonometer_embeddable', 'stopWords',
                      self.gf('django.db.models.fields.CharField')(max_length=600, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Embeddable.createdDate'
        db.delete_column(u'hedonometer_embeddable', 'createdDate')

        # Deleting field 'Embeddable.updatedDate'
        db.delete_column(u'hedonometer_embeddable', 'updatedDate')

        # Deleting field 'Embeddable.stopWords'
        db.delete_column(u'hedonometer_embeddable', 'stopWords')
