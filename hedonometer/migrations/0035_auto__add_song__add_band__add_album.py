...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Song'
        db.create_table(u'hedonometer_song', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('genres', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'hedonometer', ['Song'])

        # Adding model 'Band'
        db.create_table(u'hedonometer_band', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('happs', self.gf('django.db.models.fields.FloatField')()),
            ('labMTfile', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'hedonometer', ['Band'])

        # Adding M2M table for field albums on 'Band'
        m2m_table_name = db.shorten_name(u'hedonometer_band_albums')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('band', models.ForeignKey(orm[u'hedonometer.band'], null=False)),
            ('album', models.ForeignKey(orm[u'hedonometer.album'], null=False))
        ))
        db.create_unique(m2m_table_name, ['band_id', 'album_id'])

        # Adding model 'Album'
        db.create_table(u'hedonometer_album', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('releaseDate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'hedonometer', ['Album'])

        # Adding M2M table for field songs on 'Album'
        m2m_table_name = db.shorten_name(u'hedonometer_album_songs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('album', models.ForeignKey(orm[u'hedonometer.album'], null=False)),
            ('song', models.ForeignKey(orm[u'hedonometer.song'], null=False))
        ))
        db.create_unique(m2m_table_name, ['album_id', 'song_id'])


    def backwards(self, orm):
        # Deleting model 'Song'
        db.delete_table(u'hedonometer_song')

        # Deleting model 'Band'
        db.delete_table(u'hedonometer_band')

        # Removing M2M table for field albums on 'Band'
        db.delete_table(db.shorten_name(u'hedonometer_band_albums'))

        # Deleting model 'Album'
        db.delete_table(u'hedonometer_album')

        # Removing M2M table for field songs on 'Album'
        db.delete_table(db.shorten_name(u'hedonometer_album_songs'))
