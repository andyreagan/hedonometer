...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GutenbergAuthor'
        db.create_table(u'hedonometer_gutenbergauthor', (
            ...
            ('gutenberg_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'hedonometer', ['GutenbergAuthor'])

        # Adding model 'GutenbergBook'
        db.create_table(u'hedonometer_gutenbergbook', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pickle_object', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('lang_code_id', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('downloads', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('gutenberg_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mobi_file_path', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True)),
            ('epub_file_path', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True)),
            ('txt_file_path', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True)),
            ('expanded_folder_path', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True)),
            ('length', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('numUniqWords', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('ignorewords', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('wiki', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('scaling_exponent', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('scaling_exponent_top100', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('exclude', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('excludeReason', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'hedonometer', ['GutenbergBook'])

        # Adding M2M table for field authors on 'GutenbergBook'
        m2m_table_name = db.shorten_name(u'hedonometer_gutenbergbook_authors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gutenbergbook', models.ForeignKey(orm[u'hedonometer.gutenbergbook'], null=False)),
            ('gutenbergauthor', models.ForeignKey(orm[u'hedonometer.gutenbergauthor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['gutenbergbook_id', 'gutenbergauthor_id'])


    def backwards(self, orm):
        # Deleting model 'GutenbergAuthor'
        db.delete_table(u'hedonometer_gutenbergauthor')

        # Deleting model 'GutenbergBook'
        db.delete_table(u'hedonometer_gutenbergbook')

        # Removing M2M table for field authors on 'GutenbergBook'
        db.delete_table(db.shorten_name(u'hedonometer_gutenbergbook_authors'))
    ...
    models = {
        ...
        u'hedonometer.album': {
            ...
            'songs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['hedonometer.Song']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'hedonometer.band': {
            'Meta': {'object_name': 'Band'},
            'albums': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['hedonometer.Album']", 'symmetrical': 'False'}),
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'happs': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'labMTfile': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'hedonometer.book': {
        ...
        u'hedonometer.embeddable': {
            ...
            'nickName': ('django.db.models.fields.CharField', [], {'default': "'My super wordshift.'", 'max_length': '200'}),
        ...
        u'hedonometer.gutenbergauthor': {
            'Meta': {'object_name': 'GutenbergAuthor'},
            'fullname': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'gutenberg_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'hedonometer.gutenbergbook': {
            'Meta': {'object_name': 'GutenbergBook'},
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['hedonometer.GutenbergAuthor']", 'symmetrical': 'False'}),
            'downloads': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'epub_file_path': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'expanded_folder_path': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'gutenberg_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignorewords': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
            'lang_code_id': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'length': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'mobi_file_path': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'numUniqWords': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pickle_object': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'scaling_exponent': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'scaling_exponent_top100': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'txt_file_path': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'hedonometer.song': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'genres': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'happs': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'length': ('django.db.models.fields.IntegerField', [], {}),
            'releaseDate': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
