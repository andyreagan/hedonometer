...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.exclude'
        db.add_column(u'hedonometer_movie', 'exclude',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Movie.excludeReason'
        db.add_column(u'hedonometer_movie', 'excludeReason',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.exclude'
        db.delete_column(u'hedonometer_movie', 'exclude')

        # Deleting field 'Movie.excludeReason'
        db.delete_column(u'hedonometer_movie', 'excludeReason')
