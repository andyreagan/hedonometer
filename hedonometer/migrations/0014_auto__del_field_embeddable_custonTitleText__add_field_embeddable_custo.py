...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Embeddable.customTitleText'
        db.add_column(u'hedonometer_embeddable', 'customTitleText',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Embeddable.customTitleText'
        db.delete_column(u'hedonometer_embeddable', 'customTitleText')
