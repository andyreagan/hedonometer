...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GeoHapps'
        db.create_table(u'hedonometer_geohapps', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('stateId', self.gf('django.db.models.fields.IntegerField')()),
            ('stateName', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('value', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'hedonometer', ['GeoHapps'])


    def backwards(self, orm):
        # Deleting model 'GeoHapps'
        db.delete_table(u'hedonometer_geohapps')
