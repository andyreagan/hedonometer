...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hedonometer_embeddable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('h', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('refFile', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('refFileName', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('compFile', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('compFileName', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'hedonometer', ['Embeddable'])


    def backwards(self, orm):
        # Deleting model 'Embeddable'
        db.delete_table(u'hedonometer_embeddable')
