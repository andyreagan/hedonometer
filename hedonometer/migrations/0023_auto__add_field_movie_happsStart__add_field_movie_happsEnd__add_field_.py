...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.happsStart'
        db.add_column(u'hedonometer_movie', 'happsStart',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Movie.happsEnd'
        db.add_column(u'hedonometer_movie', 'happsEnd',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Movie.happsVariance'
        db.add_column(u'hedonometer_movie', 'happsVariance',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Movie.happsMin'
        db.add_column(u'hedonometer_movie', 'happsMin',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Movie.happsMax'
        db.add_column(u'hedonometer_movie', 'happsMax',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Movie.happsDiff'
        db.add_column(u'hedonometer_movie', 'happsDiff',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.happsStart'
        db.delete_column(u'hedonometer_movie', 'happsStart')

        # Deleting field 'Movie.happsEnd'
        db.delete_column(u'hedonometer_movie', 'happsEnd')

        # Deleting field 'Movie.happsVariance'
        db.delete_column(u'hedonometer_movie', 'happsVariance')

        # Deleting field 'Movie.happsMin'
        db.delete_column(u'hedonometer_movie', 'happsMin')

        # Deleting field 'Movie.happsMax'
        db.delete_column(u'hedonometer_movie', 'happsMax')

        # Deleting field 'Movie.happsDiff'
        db.delete_column(u'hedonometer_movie', 'happsDiff')
