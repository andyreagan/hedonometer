...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Happs.lang'
        db.add_column(u'hedonometer_happs', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='english', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Happs.lang'
        db.delete_column(u'hedonometer_happs', 'lang')
