...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Embeddable.author'
        db.alter_column(u'hedonometer_embeddable', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twython_django.TwitterProfile'], null=True))

    def backwards(self, orm):

        # Changing field 'Embeddable.author'
        db.alter_column(u'hedonometer_embeddable', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
