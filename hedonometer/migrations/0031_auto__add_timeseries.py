...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hedonometer_timeseries', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('regionID', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('sumHappsFile', self.gf('django.db.models.fields.CharField')(default='sumhapps.csv', max_length=100)),
            ('ignoreWords', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True)),
        ))
        db.send_create_signal(u'hedonometer', ['Timeseries'])


    def backwards(self, orm):
        # Deleting model 'Timeseries'
        db.delete_table(u'hedonometer_timeseries')
