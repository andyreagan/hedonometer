...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timeseries.customLongTitle'
        db.add_column(u'hedonometer_timeseries', 'customLongTitle',
                      self.gf('django.db.models.fields.CharField')(default='Average Happiness for Twitter', max_length=200),
                      keep_default=False)

        # Adding field 'Timeseries.mediaFlag'
        db.add_column(u'hedonometer_timeseries', 'mediaFlag',
                      self.gf('django.db.models.fields.CharField')(default='Tweets', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timeseries.customLongTitle'
        db.delete_column(u'hedonometer_timeseries', 'customLongTitle')

        # Deleting field 'Timeseries.mediaFlag'
        db.delete_column(u'hedonometer_timeseries', 'mediaFlag')
