...
hedotools.shifter = function() {
    ...
    var drawlogo = function() {
        ...
        canvas.append('image')
            ...
            .on("click", function() {
                window.open('https://hedonometer.org', '_blank');
            });
    }
    ...
    var plot = function() {
        ...
        */
        ...
        if (shiftseldecoder().current === "posup") {
            ...
            shiftType = 3;
            resetButton(true);
            axes.selectAll("rect.shiftrect.zero").attr("y", function(d, i) {
                return y(i + 1)
            ...
            axes.selectAll("text.shifttext.zero").attr("y", function(d, i) {
                return y(i + 1) + iBarH;
            }).attr("transform", function(d, i) {
                if (d < 0) {
                    return "translate(-500,0)";
            ...
            axes.selectAll("rect.shiftrect.one").attr("y", function(d, i) {
                return y(i + 1)
            }).attr("transform", function(d, i) {
                if (d < 0) {
                    return "translate(-500,0)";
            ...
            axes.selectAll("text.shifttext.one").attr("y", function(d, i) {
                return y(i + 1) + iBarH;
            }).attr("transform", function(d, i) {
                if (d < 0) {
                    return "translate(-500,0)";
            ...
            axes.selectAll("rect.shiftrect.two").attr("y", function(d, i) {
                return y(i + 1)
            }).attr("transform", function(d, i) {
                if (d < 0) {
                    return "translate(-500,0)";
            ...
            axes.selectAll("text.shifttext.two").attr("y", function(d, i) {
                return y(i + 1) + iBarH;
            }).attr("transform", function(d, i) {
                if (d < 0) {
                    return "translate(-500,0)";
            ...
            axes.selectAll("rect.shiftrect.three").attr("y", function(d, i) {
                return y(i + 1)
            }).attr("transform", "translate(0,0)");
            axes.selectAll("text.shifttext.three").attr("y", function(d, i) {
                return y(i + 1) + iBarH;
            }).attr("transform", "translate(0,0)");
        ...
        topbgrect2 = canvas.append("rect").attr("x", 0).attr("y", 0).attr("width", boxwidth).attr("height", toptextheight).attr("fill", "white").style({
            "opacity": "1.0"
        });
        ...
        bottombgrect = axes.append("rect").attr("x", 3).attr("y", fullheight - axeslabelmargin.bottom - toptextheight).attr("width", figwidth - axeslabelmargin.left - 5).attr("height", axeslabelmargin.bottom).attr("fill", "white").style({
            "opacity": "1.0"
        });
        ...
        axes.selectAll('.sumrectR')
            ...
            .on('click', function(d, i) {
                ...
                if (i == 0) {
                    ...
                    axes.selectAll("rect.shiftrect.zero").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1)
                    }).attr("transform", function(d, i) {
                        if (d < 0) {
                            return "translate(-500,0)";
                    ...
                    axes.selectAll("text.shifttext.zero").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1) + iBarH;
                    }).attr("transform", function(d, i) {
                        if (d < 0) {
                            return "translate(-500,0)";
                    ...
                    axes.selectAll("rect.shiftrect.one").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1)
                    }).attr("transform", function(d, i) {
                        if (d < 0) {
                            return "translate(-500,0)";
                    ...
                    axes.selectAll("text.shifttext.one").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1) + iBarH;
                    }).attr("transform", function(d, i) {
                        if (d < 0) {
                            return "translate(-500,0)";
                    ...
                    axes.selectAll("rect.shiftrect.two").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1)
                    }).attr("transform", function(d, i) {
                        if (d < 0) {
                            return "translate(-500,0)";
                    ...
                    axes.selectAll("text.shifttext.two").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1) + iBarH;
                    }).attr("transform", function(d, i) {
                        if (d < 0) {
                            return "translate(-500,0)";
                    ...
                    axes.selectAll("rect.shiftrect.three").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1)
                    }).attr("transform", "translate(0,0)");
                    axes.selectAll("text.shifttext.three").transition().duration(1000).attr("y", function(d, i) {
                        return y(i + 1) + iBarH;
                    }).attr("transform", "translate(0,0)");
                } else if (i == 1) {
                    shiftTypeSelect = true;
        ...
        function zoomed() {
            ...
            if (shiftTypeSelect) {
                for (var j = 0; j < 4; j++) {
                    axes.selectAll("rect.shiftrect." + intStr0[j]).attr("y", function(d, i) {
                        return y(i + 1)
                    });
                    axes.selectAll("text.shifttext." + intStr0[j]).attr("y", function(d, i) {
                        return y(i + 1) + iBarH;
                    })
                }
            } else {
        ...
        // 	  })
        //     .on("click", function() {
        // 	window.open('https://hedonometer.org/instructions.html#wordshifts','_blank');
        //     })
        //     .selectAll('text.help')
    ...
    var replot = function() {
        ...
        newLtoptext.transition().attr("x", function(d, i) {
            return topScale(d) - 5;
        });
...
function computeHapps() {
    ...
    var vtimeseries = Array(allDataRaw.length-minWindows+1);
	...
	//     happs += freq[i]*lens[i];
	// }
	console.log("scoring beginning timeseries");
    ...
    console.log("scoring main timeseries");
    var happs = 0.0;
    // stop the freq vector
    freq = hedotools.shifter.istopper(freq);
    for (var i=0; i<allDataRaw[j].length; i++) {
	...
	console.log("adding point "+(j+minWindows-1));
	console.log("subtracting point "+(j-1));
	...
	console.log("scoring end timeseries");	
	var happs = 0.0
	// stop the freq vector
	freq = hedotools.shifter.istopper(freq);
	for (var i=0; i<allDataRaw[j].length; i++) {
